        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    {{ Form::open(['route' => 'admin.owner.store', 'method' => 'post']) }}
                    @csrf
                    <div class="mb-6">
                    ...
                    <div class="mb-6">
                        ...
                        {{ Form::email('email', old('email'), ['class'=>'shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light']) }}
                    </div>
                    <div class="mb-6">
                        {{ Form::label('password', __('owner.attribute_labels.'), ['class'=>'block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300']) }}
                    ...
                    <button type="submit"
                            class="text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none
                                ...
                                text-sm px-4 py-2.5 text-center mr-2 mb-2"><i class="fa-solid fa-wrench"></i>{{ __('common.btn_labels.register') }}
                    </button>
                    {{ Form::close() }}
                </div>
            </div>
