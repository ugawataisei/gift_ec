                            ...
                            <div class="p-5">
                                ...
                                <div class="ms-auto">
                                    @if ($model->is_selling ===  0)
                                        <span
                                            class="bg-red-100 text-red-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-red-200 dark:text-red-900">販売停止</span>
                                    @else
                                        <span
                                            class="bg-blue-100 text-blue-800 text-sm font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-blue-200 dark:text-blue-800">販売中</span>
                                    @endif
                                    <button type="button"
                                            onclick="location.href='{{ route('owner.shop.edit', ['id' => $model->id]) }}'"
