        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="mb-6">
                        {{ Form::label('name', __('shop.attribute_labels.name'), ['class'=>'block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300']) }}
                    ...
                    <div class="mb-6">
                        {{ Form::label('information', __('shop.attribute_labels.information'), ['class'=>'block mb-2 text-sm font-medium text-gray-900 dark:text-white']) }}
                    ...
                    <div class="mb-6">
                        {{ Form::label('is_selling', __('shop.attribute_labels.is_selling'), ['class'=>'block mb-2 text-sm font-medium text-gray-900 dark:text-white']) }}
